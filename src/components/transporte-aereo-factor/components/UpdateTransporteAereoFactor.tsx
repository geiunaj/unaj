...
import {
  showTransporteAereoFactor,
  updateTransporteAereoFactor,
} from "../services/transporteAereoFactor.actions";
...
export function UpdateFormTransporteAereoFactor({
  id,
  onClose,
}: UpdateTransporteAereoFactorProps) {
  ...
  const onSubmit = async (
    data: z.infer<typeof UpdateTransporteAereoFactor>
  ) => {
    ...
    try {
      const response = await updateTransporteAereoFactor(
        id,
        transporteAereoFactorRequest
      );
      onClose();
