...
import {UpdateFormAnio} from "@/components/anio/components/UpdateFormAnio";
...
export default function AnioPage() {
    ...
    const handleDelete = useCallback(async () => {
        try {
            const response = await deleteAnio(idForDelete);
        ...
        <div className="w-full max-w-[1150px] h-full">
                    ...
                    <div className="flex flex-col gap-1 sm:flex-row sm:gap-4 w-1/2">
                        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                            ...
                            <DialogContent className="max-w-lg border-2">
                                <DialogHeader>
                                    <DialogTitle>Anio</DialogTitle>
                                    <DialogDescription>
                                        Agregar Anio
                                    </DialogDescription>
                                    <DialogClose/>
                                </DialogHeader>
                                <CreateFormAnio onClose={handleClose}/>
                            </DialogContent>
                        </Dialog>
                    </div>
                </div>
            ...
            <div className="rounded-lg overflow-hidden text-nowrap sm:text-wrap">
                <Table>
                    ...
                    <TableBody>
                        {anios.data!.map((item: Anio, index: number) => (
            ...
            <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
                ...
                <DialogContent>
                    ...
                    <UpdateFormAnio onClose={handleCloseUpdate} id={idForUpdate}/>
                </DialogContent>
            </Dialog>
