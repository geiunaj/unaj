...
import {CreateFormTipoVehiculo} from "./CreateFormTipoVehiculo";
import {errorToast, successToast} from "@/lib/utils/core.function";
import {UpdateFormTipoVehiculo} from "@/components/tipoVehiculo/components/UpdateFormTipoVehiculo";
import {deleteTipoVehiculo} from "@/components/tipoVehiculo/services/tipoVehiculo.actions";
import {
    TipoVehiculoCollectionItem,
} from "@/components/tipoVehiculo/services/tipoVehiculo.interface";
import {useTipoVehiculo} from "@/components/tipoVehiculo/lib/tipoVehiculo.hook";
...
export default function TipoVehiculoPage() {
    ChangeTitle("Tipos de Vehiculos");
    //DIALOGS
    ...
    //USE QUERIES
    const tipoVehiculoQuery = useTipoVehiculo(name, page);
    ...
    const handleDelete = useCallback(async () => {
        try {
            const response = await deleteTipoVehiculo(idForDelete);
            setIsDeleteDialogOpen(false);
            successToast(response.data.message);
        } catch (error: any) {
            errorToast(
                error.response?.data?.message || "Error al eliminar el tipo de vehiculo"
            );
        } finally {
            await tipoVehiculoQuery.refetch();
        }
    }, [tipoVehiculoQuery]);
    ...
    if (tipoVehiculoQuery.isLoading) {
        ...
        <div className="w-full max-w-screen-xl h-full">
                        ...
                        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                            ...
                            <DialogContent className="max-w-lg border-2">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Agregar Tipo de Vehiculo</DialogDescription>
                                    <DialogClose/>
                                </DialogHeader>
                                <CreateFormTipoVehiculo onClose={handleClose}/>
                            </DialogContent>
                        </Dialog>
                    </div>
                </div>
            ...
            <div className="rounded-lg overflow-hidden text-nowrap sm:text-wrap">
                <Table>
                    ...
                    <TableBody>
                        {tipoVehiculoQuery.data!.data.map(
                            (item: TipoVehiculoCollectionItem) => (
                ...
                {tipoVehiculoQuery.data!.meta.totalPages > 1 && (
                    <CustomPagination
                        meta={tipoVehiculoQuery.data!.meta}
            ...
            <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
                ...
                <DialogContent>
                    ...
                    <UpdateFormTipoVehiculo onClose={handleCloseUpdate} id={idForUpdate}/>
                </DialogContent>
            </Dialog>
