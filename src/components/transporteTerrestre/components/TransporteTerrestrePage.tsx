        ...
        <div className="w-full max-w-[1150px] h-full">
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-start mb-6">
                <div className="font-Manrope">
                    <h1 className="text-base text-foreground font-bold">Transporte Terrestre Contratados</h1>
            ...
            <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Actualizar registro de Transporte Terrestre</DialogTitle>
                        <DialogDescription>
                            Indicar el historial de Transporte Terrestre
                        </DialogDescription>
                    </DialogHeader>
                    <UpdateFormTransporteTerrestre onClose={handleCloseUpdate} id={idForUpdate}/>
                </DialogContent>
            </Dialog>
