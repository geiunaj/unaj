...
import { UpdateFormTransporteCasaTrabajo } from "@/components/transporteCasaTrabajo/components/UpdateFormTransporteCasaTrabajo";
    ...
    <div className="w-full max-w-screen-xl h-full">
      ...
      <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Actualizar Registro de Transporte Casa Trabajo
            </DialogTitle>
