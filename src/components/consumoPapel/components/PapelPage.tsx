...
import ReportComponent, { ReportRequest } from "@/components/ReportComponent";
...
const handleClickReport = useCallback(async (period: ReportRequest) => {
    ...
    await GenerateReport(data.data!.data, columns, formatPeriod(period), "REPORTE DE CONSUMO DE PAPEL");
}, [ConsumoPapelReport]);
