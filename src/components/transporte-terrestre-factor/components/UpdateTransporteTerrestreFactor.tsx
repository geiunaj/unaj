...
export function UpdateFormTransporteTerrestreFactor({
  id,
  onClose,
}: UpdateTransporteTerrestreFactorProps) {
  ...
  }, [transporteTerrestreFactor.data, id]);
  ...
  const onSubmit = async (
    data: z.infer<typeof UpdateTransporteTerrestreFactor>
  ) => {
    ...
    try {
      const response = await updateTransporteTerrestreFactor(
        id,
        transporteTerrestreFactorRequest
      );
      onClose();
