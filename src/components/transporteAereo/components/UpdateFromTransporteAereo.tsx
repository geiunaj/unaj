...
export function UpdateFormTransporteAereo({id, onClose}: UpdateTransporteAereoProps) {
    ...
    const loadForm = useCallback(() => {
        if (transporteAereos.data) {
            form.reset({
                numeroPasajeros: transporteAereos.data.numeroPasajeros ?? 0,
                ...
                anio: transporteAereos.data.anio_id.toString(),
                sede: transporteAereos.data.sede_id.toString(),
                mes: transporteAereos.data.mes_id.toString(),
            });
        }
