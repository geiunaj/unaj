    ...
    <div className="w-full max-w-screen-xl h-full">
            ...
            {consumible.data!.data.map(
              (item: ConsumibleCollectionItem, index: number) => (
                <TableRow key={item.id} className="text-center">
                  ...
                  <TableCell className="text-xs w-[20%]  whitespace-nowrap overflow-hidden text-ellipsis">
                    {item.categoria}
                  </TableCell>
                  <TableCell className="text-xs text-start max-w-72 whitespace-nowrap overflow-hidden text-ellipsis">
                    {item.tipoConsumible}
                  </TableCell>
                  <TableCell className="text-xs max-w-24 whitespace-nowrap overflow-hidden text-ellipsis">
                    {item.grupo}
                  </TableCell>
                  <TableCell className="text-xs max-w-48 whitespace-nowrap overflow-hidden text-ellipsis">
                    {item.proceso}
                  </TableCell>
                  <TableCell className="text-xs max-w-[20%] whitespace-nowrap overflow-hidden text-ellipsis">
                    <Badge variant="default">{item.pesoTotal}</Badge>
                  </TableCell>
                  <TableCell className="text-xs">{item.unidad}</TableCell>
                  <TableCell className="text-xs">{item.anio}</TableCell>
      ...
      <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
        ...
        <DialogContent>
          ...
          <UpdateFormConsumible onClose={handleCloseUpdate} id={idForUpdate} />
        </DialogContent>
      </Dialog>
