...
export default function Sidebar({ urlLogo, urlLogoDark }: SidebarProps) {
  ...
  const logoAlt = resolvedTheme === "dark" ? "Logo UNAJ Dark" : "Logo UNAJ";
                      ...
                      .map((subItem) => {
                        ...
                        return (
                          <Button
                            key={subItem.title}
                            variant={
                              itemActive === subItem.href ? "default" : "ghost"
                            }
                            className={
