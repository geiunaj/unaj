...
export default function ActivosPage() {
  ...
  //SELECTS - FILTERS
  const [selectedTipoActivoId, setSelectedTipoActivoId] = useState<string>("");
    ...
    <div className="w-full max-w-screen-xl h-full">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="font-Manrope text-[10px] leading-3 font-bold text-center py-1">
                COSTO
                <br /> TOTAL <span className="text-[9px]">[S/.]</span>
              </TableHead>
              <TableHead className="font-Manrope text-[10px] leading-3 font-bold text-center py-1">
                CANTIDAD <br /> CONSUMIDA{" "}
                <span className="text-[9px]">[kg]</span>
              </TableHead>
              <TableHead className="font-Manrope text-[10px] leading-3 font-bold text-center py-1">
                CONSUMO
                <br /> TOTAL <span className="text-[9px]">[kg]</span>
              </TableHead>
              <TableHead className="font-Manrope text-xs font-bold text-center py-1">
                AÑO
              </TableHead>
      ...
      <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
        ...
        <DialogContent>
          ...
          <UpdateFormActivo onClose={handleCloseUpdate} id={idForUpdate} />
        </DialogContent>
      </Dialog>
