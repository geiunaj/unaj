...
export default function ConsumoAguaPage() {
  ...
  if (
    consumoAgua.isLoading ||
    areas.isLoading ||
    sedes.isLoading ||
    anios.isLoading ||
    meses.isLoading ||
    consumoAguaReport.isLoading
  ) {
    ...
    <div className="w-full max-w-screen-xl h-full">
          ...
          <div className="grid grid-cols-2 grid-rows-1 w-full gap-2 sm:flex sm:justify-between justify-center">
            ...
            <div className="flex flex-col-reverse justify-end gap-1 w-full sm:flex-row sm:gap-2">
              ...
              <ExportPdfReport
                ...
                fileName={`REPORTE DE CONSUMO DE AGUA_${formatPeriod(
                  { from, to },
                  true
                )}`}
                columns={[
      ...
      <div className="rounded-lg overflow-hidden text-nowrap sm:text-wrap flex flex-col gap-10">
        <Table>
          ...
          <TableBody>
            {consumoAgua.data!.data.map(
              (item: consumoAguaCollectionItem, index: number) => (
      ...
      <Dialog open={isUpdateDialogOpen} onOpenChange={setIsUpdateDialogOpen}>
        ...
        <DialogContent>
          ...
          <UpdateFormConsumoAgua onClose={handleCloseUpdate} id={idForUpdate} />
        </DialogContent>
      </Dialog>
