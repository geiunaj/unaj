    ...
    try {
        ...
        const fertilizantes = await prisma.fertilizante.findMany({
            where: {
                ...
                anio_id: anioId,
                tipoFertilizante_id: tipoFertilizanteId ? parseInt(tipoFertilizanteId) : undefined,
            },
            include: {
                anio: true,
                sede: true,
        ...
        return new NextResponse("Error al buscar los fertilizantes", { status: 500 });
    }
}
...
export async function POST(req: NextRequest): Promise<NextResponse> {
    try {
        ...
        if (
            ...
            return new NextResponse("Campos requeridos faltantes o inválidos", { status: 400 });
        }
