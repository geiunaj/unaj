...
export async function GET(req: NextRequest): Promise<NextResponse> {
  try {
    ...
    const tipoFertilizanteId =
      searchParams.get("tipoFertilizanteId") ?? undefined;
    const claseFertilizante =
      searchParams.get("claseFertilizante") ?? undefined;
    ...
    const totalRecords = await prisma.fertilizante.count({
      where: whereOptions,
    });
