  ...
  try {
    ...
    if (!factorEmisionSEIN) {
      return NextResponse.json(
        { message: "Factor de emisión SEIN no encontrado" },
        { status: 404 }
      );
    }
    ...
    return NextResponse.json(
      { message: "Error buscando factor de emisión SEIN" },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { message: "Error actualizando factor de emisión SEIN" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { message: "Error eliminando factor de emisión SEIN" },
      { status: 500 }
    );
  }
}
