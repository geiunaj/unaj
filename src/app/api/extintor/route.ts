...
import {
    ExtintorRequest,
} from "@/components/extintor/service/extintor.interface";
...
export async function GET(req: NextRequest): Promise<NextResponse> {
    try {
        ...
        const formattedExtintor: any[] = extintor.map(
            (extintor, index) => {
        ...
        return NextResponse.json({message: "Error finding extintor"}, {status: 500});
    }
}
