  ...
  try {
    ...
    if (!ExtintorFactor) {
      return NextResponse.json(
        { message: "Factor de Extintor no encontrado" },
        { status: 404 }
      );
    }
    ...
    return NextResponse.json(
      { message: "Error buscando Factor de Extintor" },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { message: "Error actualizando Factor de Extintor" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { message: "Error eliminando Factor de Extintor" },
      { status: 500 }
    );
  }
}
