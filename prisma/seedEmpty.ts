...
async function main() {
  ...
  const grupoActivos = [
    { nombre: "Steel hot rolled sheet USA", categoria: "Metal" },
    {
    ...
    { nombre: "PP (Polypropylene)", categoria: "Polipropileno" },
    { nombre: "Steel hot rolled sheet USA", categoria: "Acero" },
    { nombre: "Electrical items - IT", categoria: "Teclado" },
    {
      nombre: "PE (HDPE, High density Polyethylene)",
      categoria: "Polietileno alta densidad",
    },
    { nombre: "Particle board  standard (Rotterdam)", categoria: "Melamina" },
    { nombre: "Electrical items - IT", categoria: "Equipo TI" },
    { nombre: "PP (Polypropylene)", categoria: "Polpropileno" },
    {
